...
DTP_FILTER_SCENARIOS = [
    ...
    ("withNegativeEnvFactors", True, "ДТП с неудовлетворительными дорожными условиями"),
...
# (Имя_фильтра, Ожидаемый_результат, Описание)
    ...
    ("zonedDateFilterParams", {
        "dateFrom": "2019-12-31T23:00:00",
        "dateTo": "2020-12-31T22:59:59"}, "Неверный формат веремени"),
